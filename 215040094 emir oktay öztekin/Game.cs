...
namespace DGD203
{
    public class Game
    {
        ...
        {
            _gameMap = new Room(this, _defaultMapWidth, _defaultMapHeight);
        }
        ...
        private void StartGameLoop()
        {
            while (_gameRunning)
            {
                ...
                if (CheckVictory() || CheckPlayerDead())
                {
                    EndGame();
                }
            }
        ...
        {
            if (_gameMap.MapCompleted)
            {
                Console.ForegroundColor = ConsoleColor.Green;
                Console.WriteLine("Comgratulations you have completed the game!");
                Console.ForegroundColor = ConsoleColor.Gray;
            }

            return _gameMap.MapCompleted;
        }
